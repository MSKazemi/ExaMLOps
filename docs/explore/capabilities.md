...
description: All 405 exa commands, grouped into the twelve lifecycle areas of exa --help, searchable.
hide:
  - navigation
---
...
Everything ExaMLOps can do is reachable from the `exa` CLI: **405 commands**
in 63 command groups. They are grouped here the same way `exa --help` groups
