...
description: All 473 exa commands, grouped into the twelve lifecycle areas of exa --help, searchable.
hide:
  - navigation
---
...
Everything ExaMLOps can do is reachable from the `exa` CLI: **473 commands**
...
| Serving & Inference | Serve models, split traffic, call gateways and query RAG. | `serve`, `predict`, `production`, `gateway`, `vector`, `rag` | 78 |
