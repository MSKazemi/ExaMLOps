...
Open **http://localhost:18888** (or **http://<REMOTE_HOST>:18888** on remote server `lxp-cpu01`, or use `ssh lxp` port-forward).
...
MLflow UI is also reachable in the browser at **http://localhost:15000** (host) or **http://<REMOTE_HOST>:15000** (lxp-cpu01).
...
Ray Dashboard: **http://localhost:18265** (local) / **http://<REMOTE_HOST>:18265** (lxp-cpu01).
...
Prefect UI: **http://localhost:14200** (local) / **http://<REMOTE_HOST>:14200** (lxp-cpu01).
...
|---|---|---|
| JupyterHub | http://localhost:18888 | http://<REMOTE_HOST>:18888 |
