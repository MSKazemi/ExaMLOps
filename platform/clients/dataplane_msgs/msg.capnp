# Cap'n'Proto message types for ExaMLOps ↔ DataPlane integration.
# These types are defined locally in ai-productions so the dataplane repo
# remains unmodified. The payloadType integers (5-10) match the agreed
# message type numbering used by the dataplane message envelope.
