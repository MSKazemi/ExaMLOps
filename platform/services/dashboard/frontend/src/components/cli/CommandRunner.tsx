...
interface Props {
  ...
  autoRun?: boolean
  /** Output format to start from (a previous run's, for "Run again"). */
  initialFormat?: 'json' | 'text'
  /** A line shown above the form — e.g. that it was loaded from an earlier run. */
  note?: string
}
...
export function CommandRunner({
  ...
  const [format, setFormat] = useState<'json' | 'text'>(initialFormat)
