...
URL_KEYS: frozenset[str] = frozenset(
    {
        ...
        "dataplane_port",
        "dataplane_mode",
        "dataplane_job_topic_uuid",
        "dataplane_result_topic_uuid",
        "dataplane_inference_uuid",
        "dataplane_retrain_uuid",
        "dataplane_default_model",
        "dataplane_default_alias",
...
ENV_VAR_MAP: dict[str, str] = {
    ...
    "dataplane_job_topic_uuid": "DATAPLANE_JOB_TOPIC_UUID",
    "dataplane_result_topic_uuid": "DATAPLANE_RESULT_TOPIC_UUID",
    "dataplane_inference_uuid": "DATAPLANE_INFERENCE_UUID",
    "dataplane_retrain_uuid": "DATAPLANE_RETRAIN_UUID",
    "dataplane_default_model": "DATAPLANE_DEFAULT_MODEL",
    "dataplane_default_alias": "DATAPLANE_DEFAULT_ALIAS",
...
async def export_env(
    ...
    lines: list[str] = [
        ...
        "#   docker-compose restart mlflow ray-serve control-plane dataplane-bridge",
        "",
    ]
