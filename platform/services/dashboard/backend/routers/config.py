...
ENV_VAR_MAP: dict[str, str] = {
    ...
    "seanerbus_host": "SEANERBUS_HOST",
    "seanerbus_port": "SEANERBUS_PORT",
    "seanerbus_mode": "SEANERBUS_MODE",
    "seanerbus_job_topic_uuid": "SEANERBUS_JOB_TOPIC_UUID",
    "seanerbus_result_topic_uuid": "SEANERBUS_RESULT_TOPIC_UUID",
    "seanerbus_inference_uuid": "SEANERBUS_INFERENCE_UUID",
    "seanerbus_retrain_uuid": "SEANERBUS_RETRAIN_UUID",
    "seanerbus_default_model": "SEANERBUS_DEFAULT_MODEL",
    "seanerbus_default_alias": "SEANERBUS_DEFAULT_ALIAS",
...
async def export_env(
    ...
    lines: list[str] = [
        ...
        "#   docker-compose restart mlflow ray-serve control-plane seanerbus-bridge",
        "",
    ]
