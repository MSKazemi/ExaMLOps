#!/usr/bin/env bash
# Open SSH tunnels for all ExaMLOps services on remote-cpu01.
# Usage: bash platform/ci/remote_tunnel.sh [user@host]
#   default host: u1002@<DATAPLANE_HOST>
set -euo pipefail

TARGET="${1:-u1002@<DATAPLANE_HOST>}"
