...
def deploy(
    ...
    # `to_deployment` is sync-compatible, typed as possibly a coroutine; synchronously it is a
    # RunnerDeployment (same ignore as deploy_from_registry below).
    prefect_serve(main, dispatch_deployment())  # type: ignore[arg-type]
