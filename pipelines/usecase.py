...
_LEGACY_FRAMEWORK: dict[str, str] = {
    "model_base": "modelzoo.models.common.dataplane_model:DataplaneModel",
    "config_base": (
        "modelzoo.models.common.dataplane_configurator:DataplaneModelConfiguration"
    ),
    "pipeline_step": "modelzoo.decorators:pipeline_step",
    "model_params": "modelzoo.models.common.dataplane_configurator:DataplaneModelParams",
    "dataloader": "modelzoo.dataloader.dataplane_dataloader:DataplaneDataloader",
    "dataloader_params": (
        "modelzoo.models.common.dataplane_configurator:DataplaneDataloaderParams"
    ),
    "get_backend": "modelzoo.datasets._backends:get_backend",
    "framework_adapter": "modelzoo.models.common.framework_adapter:adapter_for",
    "model_task": "modelzoo.models.common.dataplane_model:DataplaneModelTask",
    "tasks_root": "modelzoo.models.tasks",
}
_LEGACY_DATASETS = {
    "PM100Dataset": "modelzoo.datasets.pm100:PM100Dataset",
    "FDataDataset": "modelzoo.datasets.f_data:FDataDataset",
}
