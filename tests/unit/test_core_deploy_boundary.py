...
BASELINE: dict[str, dict[str, int]] = {
    ...
    "platform/clients/dataplane_bus_bridge.py": {"sys_path": 2},
    "platform/clients/dataplane_bus_test_pub.py": {"sys_path": 1},
    "platform/clients/dataplane_bus_test_req.py": {"repo_root": 1, "sys_path": 1},
