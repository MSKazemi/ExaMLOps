...
BASELINE: dict[str, dict[str, int]] = {
    ...
    "platform/cli/src/examlops/cli/commands/doctor.py": {"repo_root": 1},
    "platform/cli/src/examlops/cli/commands/hpc_cmd.py": {
        "deploy_ref": 1,
        "repo_root": 1,
        "sys_path": 1,
    },
    "platform/cli/src/examlops/cli/commands/instance_cmd.py": {"repo_root": 2},
    "platform/cli/src/examlops/cli/commands/modules_cmd.py": {"deploy_ref": 3},
    ...
    "platform/services/dashboard/backend/cli_store.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/ab_testing.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/admission.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/alerts.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/autopilot.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/batch.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/bff.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/cards.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/cli.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/collab.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/compliance.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/config.py": {"deploy_ref": 2},
    "platform/services/dashboard/backend/routers/connections.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/copilot.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/drift_data.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/events.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/explain.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/facility.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/fairness.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/feature_store.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/features.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/finops.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/flags.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/gateway.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/governance.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/hpo.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/llmops.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/mlops.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/models.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/namespace.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/nextgen.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/platform_audit.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/platform_data.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/projects.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/prompts.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/providers.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/quality.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/rollback.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/scaffold.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/scaling.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/search.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/secrets.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/shadow.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/slo.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/routers/workbenches.py": {"deploy_ref": 1},
    "platform/services/dashboard/backend/selfobs.py": {"deploy_ref": 1},
